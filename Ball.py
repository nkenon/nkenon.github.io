...
w_location = int(SCREEN_HEIGHT/3)
z_location = int(SCREEN_WIDTH/3)
...
while not done:
    ...
    pygame.draw.circle(screen, ball_color, [w_location, z_location], ball_size)
    ...
    if w_location >= SCREEN_WIDTH - ball_size or w_location < ball_size:
        x_speed = x_speed * -1

    if z_location >= SCREEN_HEIGHT - ball_size or z_location < ball_size:
        y_speed = y_speed * -1
